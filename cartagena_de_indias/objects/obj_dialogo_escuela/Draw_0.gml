...
var total_frames = sprite_get_number(spr_dialogo_escuela); // Obtener el total de frames del sprite
...
var scale_x = bar_width / sprite_get_width(spr_dialogo_escuela);
var scale_y = bar_height / sprite_get_height(spr_dialogo_escuela);

// Dibujar el sprite de la barra de carga con el tamaño y frame correspondientes al progreso
draw_sprite_ext(spr_dialogo_escuela, current_frame, bar_x, bar_y, scale_x, scale_y, 0, c_white, 1);
